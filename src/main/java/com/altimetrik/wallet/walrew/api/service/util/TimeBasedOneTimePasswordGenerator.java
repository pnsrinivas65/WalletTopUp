...
public class TimeBasedOneTimePasswordGenerator extends HmacOneTimePasswordGenerator {
	 ...
	 * ({@value HmacOneTimePasswordGenerator#DEFAULT_PASSWORD_LENGTH}
	 * decimal digits), and HMAC algorithm
	 * ({@value HmacOneTimePasswordGenerator#HOTP_HMAC_ALGORITHM}).
	 *
	 ...
	 *            generated; must be between 4 and 8, inclusive
	 *
	 * @throws NoSuchAlgorithmException
	 *             if the underlying JRE doesn't support the
	 *             {@value HmacOneTimePasswordGenerator#HOTP_HMAC_ALGORITHM}
	 ...
	 *            {@value TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA1},
	 *            {@value TimeBasedOneTimePasswordGenerator#TOTP_ALGORITHM_HMAC_SHA256},
	 *            and
